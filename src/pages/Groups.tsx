      ...
      <div className="pt-24 pb-12 container mx-auto px-4 max-w-2xl">
        ...
        <Card className="border-primary/20">
          <CardContent className="p-12 text-center">
            ...
            <h2 className="text-xl font-semibold mb-2">Groups Feature</h2>
            <p className="text-muted-foreground mb-6 max-w-md mx-auto">
              Create and join groups based on your interests. Share posts, organize events, and connect with like-minded people in your community.
            </p>
            {!user && (
              <Link to="/auth">
