  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      toast({
        ...
        description: "Welcome to GwagsPortrait!",
      });
    }
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <Card className="w-full max-w-md border-primary/20 bg-card">
        <CardHeader className="text-center">
          <CardTitle className="text-3xl font-bold text-primary">GwagsPortrait</CardTitle>
          <CardDescription className="text-muted-foreground">
            Join the community of portrait enthusiasts
          </CardDescription>
        </CardHeader>
        <CardContent>
